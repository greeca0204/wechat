...
;~function(res){
	...
	res.load = function(){
		...
		res.queue.loadFile("../assets/images/hitboss/start.png");
		res.queue.loadFile("../assets/images/hitboss/rulebtn.png");
		res.queue.loadFile("../assets/images/hitboss/startbtn.png");
		res.queue.loadFile("../assets/images/hitboss/rankbtn.png");
		
		res.queue.loadFile("../assets/images/hitboss/penguin.png");
		res.queue.loadFile("../assets/images/hitboss/bear.png");
		res.queue.loadFile("../assets/images/hitboss/hill.png");
		res.queue.loadFile("../assets/images/hitboss/guide.png");
		res.queue.loadFile("../assets/images/hitboss/background1.png");
		res.queue.loadFile("../assets/images/hitboss/background2.png");
		res.queue.loadFile("../assets/images/hitboss/flyend.png");
		res.queue.loadFile("../assets/images/hitboss/traces.png");
		res.queue.loadFile("../assets/images/hitboss/longtraces.png");
		res.queue.loadFile("../assets/images/hitboss/score.png");
		res.queue.loadFile("../assets/images/hitboss/fly.png");
		
		res.queue.loadFile("../assets/images/hitboss/end.png");
		res.queue.loadFile("../assets/images/hitboss/againbtn.png");
		res.queue.loadFile("../assets/images/hitboss/notifybtn.png");
	}
...
Main.startGame = function(){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../assets/images/hitboss/start.png")));
	
	
	// 开始游戏
	var beginGame = new createjs.Bitmap(Resource.get("../assets/images/hitboss/startbtn.png"));
	...
	//游戏规则
	var gameRule = new createjs.Bitmap(Resource.get("../assets/images/hitboss/rulebtn.png"));
	gameRule.setTransform(377, 580);
	gameRule.cursor = "pointer";
	gameRule.addEventListener("click", function(){
		new Function(popup_1_js.innerHTML)();
	});
	container.addChild(gameRule);
...
Main.endGame = function(distance){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../assets/images/hitboss/end.png")));
	...
	// 再来一次
	var again = new createjs.Bitmap(Resource.get("../assets/images/hitboss/againbtn.png"));
	...
	// 通知好友
	var notify = new createjs.Bitmap(Resource.get("../assets/images/hitboss/notifybtn.png"));
	...
	// 游戏排行榜
	var rankBoard = new createjs.Bitmap(Resource.get("../assets/images/hitboss/rankbtn.png"));
	rankBoard.setTransform(Main.width/2-155, 745);
	rankBoard.addEventListener("click", function(){
		getRankBoard();
	});
	container.addChild(rankBoard);
...
Main.initGame = function(){
	...
	var b1 = new createjs.Bitmap(Resource.get("../assets/images/hitboss/background2.png"));
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../assets/images/hitboss/background2.png"));
	b1.x = Main.width;
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../assets/images/hitboss/background1.png"));
	b1.x = Main.width * 2;
	img.addChild(b1);
	...
	Main.log("初始化：员工");
	var bearImg = new createjs.Bitmap(Resource.get("../assets/images/hitboss/bear.png"));
	...
	var bearSS = new createjs.SpriteSheet({
		...
		"images": [Resource.get("../assets/images/hitboss/bear.png")],
		"frames":{
			"height": 360,
			"width":300,
			"regX": 0,
	...
	// 路标
	Main.log("初始化:路标");
	var guideBackground = new createjs.Bitmap(Resource.get("../assets/images/hitboss/guide.png"));
	...
	var guideText = new createjs.Text("", "28px Arial Black", "#FFFFFF");
	guideText.y = 40;
	...
	Main.log("初始化：上司");
	var penguinImg = new createjs.Bitmap(Resource.get("../assets/images/hitboss/penguin.png"));
	...
	var penguinSS = new createjs.SpriteSheet({
		...
		,"images" : [Resource.get("../assets/images/hitboss/penguin.png")]
		,"frames" : {
			width: 180,
			height: 170,
			count: 6
	...
	Main.log("初始化:游戏结束的上司");
	var endData = {
		images: [Resource.get("../assets/images/hitboss/flyend.png")],
	...
	Main.gameOverScoreBg = new createjs.Bitmap(Resource.get("../assets/images/hitboss/score.png"));
...
Main.moveGuide = function(distance, totalDistance){
	...
	if(this.guideMoveLength >= this.guideDistance + this.guideWidth){
		++Main.guideMoveIndex;
		++Main.guideMoveIndex;
		this.reset.guide(Main.guideMoveIndex * 450 + 'M');
...
Main.getTotalDistance = function(distance){
	Main.log(distance);
	var result = Main.guideMoveIndex * 450;
